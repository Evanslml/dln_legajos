function goLogin() {
  ...
  connect.onreadystatechange = function() {
    if(connect.readyState == 4 && connect.status == 200) {
      ...
      result += '<strong> espere porfavor....   </strong> <img src="http://172.16.20.48:8080/dln_legajos/view/bootstrap-default/img/ajax-loader.gif"> </span>';
      result += '</div>';
      __('_AJAX_LOGIN_').innerHTML = result;
    }
  }
  connect.open('POST','http://172.16.20.48:8080/dln_legajos/ajax.php?mode=login',true);
