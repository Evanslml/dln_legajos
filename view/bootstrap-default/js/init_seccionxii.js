  ...
  function AddCertificado(parameter) {
      return '<div class="col-md-4 border-seccion">\
                <h6 class="subtitle" style="margin:9px">TIPO <i class="danger">*</i></h6>\
                  ...
                  <select data-placeholder="SELECCIONE" class="chosen-select-deselect cbx_grado1" tabindex="2" name="cbx_tipo_evaluacion" id="cbx_tipo_evaluacion">\
                      <option value=""></option>\
...
/*********************************************************************************************************************************/
  ...
  function get_data_form() {
    ...
    for (var i = 1; i <= nFilas_childs; i++) {
          var MTABL_ID          = $(".datos_certificados .row-agregado-resolucion:nth-child("+i+") #cbx_tipo_evaluacion").find('option:selected').prop('value');
    ...
    //console.log(array);
      ...
      $.ajax({
          type: 'POST',
          url: './public/user/ajax/secciones/seccionxii.php?action=formulario',
