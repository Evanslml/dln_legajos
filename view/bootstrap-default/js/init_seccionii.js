...
function get_data_form(){
   ...
   var MPERS_NUMDOC=$('#dni').val();
    ...
    array.push(MPERS_NUMDOC,nFilas_childs);
      ...
      $.ajax({
          type: 'POST',
          url: './public/user/ajax/secciones/seccionii.php?action=formulario',
...
function subida_realizada(i){
  ...
  var archivos = [ 
      {dni : MPERS_NUMDOC, obj : MOBJ_ID, nom : 'CURRICULUM VITAE', arc : '15', fil : '15'},
      {dni : MPERS_NUMDOC, obj : MOBJ_ID, nom : 'CERTIFICADO DE ESTUDIOS', arc : '16', fil : '16'},
      {dni : MPERS_NUMDOC, obj : MOBJ_ID, nom : 'TITULO / DOCTORADO / OTROS', arc : '17', fil : '17'},
      {dni : MPERS_NUMDOC, obj : MOBJ_ID, nom : 'HABILIDAD PROFESIONAL', arc : '18', fil : '18'}
    ];  
