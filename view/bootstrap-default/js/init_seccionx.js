...
/*********************************************************************************************************************************/
  ...
  function get_data_form() {
    ...
    //console.log(array);
      ...
      $.ajax({
          type: 'POST',
          url: './public/user/ajax/secciones/seccionx.php?action=formulario',
          ...
          success: function (response) {
                ...
                if(response ==0){
                    subida_realizada(0);
                    subida_archivos(MPERS_NUMDOC,'11','CERTIFICADO ANUAL DE HABERES Y DESCUENTOS','34','34','')
                } else{
                    after_process();
...
function subida_realizada(i){
  ...
  for (var m = 1; m <= nFilas_childs; m++) {
      ...
      archivos.push({dni:MPERS_NUMDOC, obj:MOBJ_ID, nom:NOMBRE, arc: '33'+'.'+i, fil: input  });
  }  
