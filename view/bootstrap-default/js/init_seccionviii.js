  ...
  function AddCertificado(parameter) {
      return '<div class="col-md-4 border-seccion">\
                <h6 class="subtitle" style="margin:9px">TIPO <i class="danger">*</i></h6>\
                  ...
                  <select data-placeholder="SELECCIONE" class="chosen-select-deselect cbx_grado1" tabindex="2" name="cbx_tipo_vacacion" id="cbx_tipo_vacacion">\
                      <option value=""></option>\
            ...
            <div class="col-md-4 border-seccion formulario-legajos">\
                <div class="group">\
                  <input class="inputMaterial" type="text"  id="txt_num_boleta" name="txt_num_boleta" required>\
            ...
            <div class="col-md-4 border-seccion relative">\
              ...
              <div class="js">\
                  <h5 class="input-file-title" style="margin: 8px">BOLETA</h5>\
...
/*********************************************************************************************************************************/
  ...
  function get_data_form() {
    ...
    for (var i = 1; i <= nFilas_childs; i++) {
          var MTABL_ID          = $(".datos_certificados .row-agregado-resolucion:nth-child("+i+") #cbx_tipo_vacacion").find('option:selected').prop('value');
          var MDOC_DESCRIPCION  = $('.datos_certificados .row-agregado-resolucion:nth-child('+i+') input#txt_num_boleta').val().toUpperCase();
          ...
          if(MTABL_ID.length == 0){
              ...
              var mensaje = 'Debe Ingresar el número de boleta'; swal_mensaje_error(mensaje); return false;
          }
    ...
    //console.log(array);
      ...
      $.ajax({
          type: 'POST',
          url: './public/user/ajax/secciones/seccionviii.php?action=formulario',
...
function subida_realizada(i){
  ...
  for (var m = 1; m <= nFilas_childs; m++) {
      ...
      archivos.push({dni:MPERS_NUMDOC, obj:MOBJ_ID, nom:NOMBRE, arc: '31'+'.'+i, fil: input  });
  }  
