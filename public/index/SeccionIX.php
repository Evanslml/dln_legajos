...
<script src="./view/bootstrap-default/js/init_seccionix.js?v=<?php echo time();?>"></script>
              ...
              <div id="legajos_1" class="collapse in row datos_certificados border-seccion-left border-seccion-right border-seccion-top border-seccion-bottom">
                <div class="row-agregado-resolucion"> 
                    ...
                    <div class="col-md-3 border-seccion formulario-legajos">
                        ...
                        <select data-placeholder="SELECCIONE" class="chosen-select-deselect" tabindex="2" name="cbx_tipo_ascenso" id="cbx_tipo_ascenso">
                            <option value=""></option>
                            <?php 
                    ...
                    <div class="col-md-4 border-seccion relative">
                      <input class="hidden" type="hidden" value="32" />
                      <div class="js pad-top-10">
                          <h5 class="input-file-title" style="margin: 3px">RESOLUCION</h5>
                          <form enctype="multipart/form-data" class="formulario_32">
                              <input name="archivo" type="file" id="file-32" class="inputfile inputfile-6"/>
                              <label for="file-32" class="mar-bot-0" style="height: 40px">
                              <span></span>
