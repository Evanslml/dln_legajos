        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="content" style="margin-bottom: 150px">
                <div>
                  <h3 class="text-center">LICENCIAS</h3>
              </div>
              <div>
              ...
              <div id="legajos_1" class="collapse in row datos_certificados border-seccion-left border-seccion-right border-seccion-top border-seccion-bottom">
                <div class="row-agregado-resolucion"> 
                    ...
                    <div class="col-md-2 border-seccion formulario-legajos">
                        ...
                        <select data-placeholder="SELECCIONE" class="chosen-select-deselect" tabindex="2" name="cbx_tipo_licencia" id="cbx_tipo_licencia">
                            <option value=""></option>
                            <?php 
                    ...
                    <div class="col-md-4 border-seccion relative">
                      <input class="hidden" type="hidden" value="30" />
                      <div class="js pad-top-10">
                          <h5 class="input-file-title" style="margin: 3px">RESOLUCION</h5>
                          <form enctype="multipart/form-data" class="formulario_30">
                              <input name="archivo" type="file" id="file-30" class="inputfile inputfile-6"/>
                              <label for="file-30" class="mar-bot-0" style="height: 40px">
                              <span></span>
