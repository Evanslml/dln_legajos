...
<script src="./view/bootstrap-default/js/init_seccionxi.js?v=<?php echo time();?>"></script>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="content" style="margin-bottom: 150px">
                <div>
                  <h3 class="text-center">REMUNERACION FAMILIAR</h3>
              </div>
              <div>
                ...
                <div class="row-agregado-resolucion"> 
                    ...
                    <div class="col-md-3 border-seccion formulario-legajos">
                        ...
                        <select data-placeholder="SELECCIONE" class="chosen-select-deselect" tabindex="2" name="cbx_tipo_remuneracion" id="cbx_tipo_remuneracion">
                            <option value=""></option>
                            <?php 
                              $_ListaGraInstruccion= Tabla::Lista(104);
                    ...
                    <div class="col-md-4 border-seccion relative">
                      <input class="hidden" type="hidden" value="35" />
                      <div class="js pad-top-10">
                          <h5 class="input-file-title" style="margin: 3px">RESOLUCION</h5>
                          <form enctype="multipart/form-data" class="formulario_35">
                              <input name="archivo" type="file" id="file-35" class="inputfile inputfile-6"/>
                              <label for="file-35" class="mar-bot-0" style="height: 40px">
                              <span></span>
