...
<script src="./view/bootstrap-default/js/init_seccionxii.js?v=<?php echo time();?>"></script>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="content" style="margin-bottom: 150px">
                <div>
                  <h3 class="text-center">EVALUACIONES</h3>
              </div>
              <div>
                  ...
                  <i class="fa fa-plus"></i> EVALUACIONES</h5> 
              </div>
               <!---->
